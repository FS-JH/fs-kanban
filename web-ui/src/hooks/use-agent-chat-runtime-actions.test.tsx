...
interface HookSnapshot {
	sendTaskChatMessage: ReturnType<typeof useAgentChatRuntimeActions>["sendTaskChatMessage"];
	loadTaskChatMessages: ReturnType<typeof useAgentChatRuntimeActions>["loadTaskChatMessages"];
	abortTaskChatTurn: ReturnType<typeof useAgentChatRuntimeActions>["abortTaskChatTurn"];
	cancelTaskChatTurn: ReturnType<typeof useAgentChatRuntimeActions>["cancelTaskChatTurn"];
}
...
function HookHarness({
	...
	const state = useAgentChatRuntimeActions({
		currentProjectId,
		onSessionSummary,
	});
...
describe("useAgentChatRuntimeActions", () => {
