// Manages the message list and send or cancel lifecycle for one native Agent session.
...
export type AgentChatMessage = RuntimeTaskChatMessage;

interface UseAgentChatSessionInput {
	taskId: string;
	onSendMessage?: (
		taskId: string,
		text: string,
...
function areMessagesEqual(left: AgentChatMessage, right: AgentChatMessage): boolean {
	return (
...
function upsertMessage(currentMessages: AgentChatMessage[], nextMessage: AgentChatMessage): AgentChatMessage[] {
...
function mergeMessages(
	...
	additionalMessages: AgentChatMessage[],
): AgentChatMessage[] {
...
}: UseAgentChatSessionInput): UseAgentChatSessionResult {
