...
export interface BuildAgentModelPickerOptionsResult {
...
): BuildAgentModelPickerOptionsResult {
...
export function formatAgentReasoningEffortLabel(
...
export function formatAgentSelectedModelButtonText({
	modelName,
	reasoningEffort,
	...
	return `${modelName} (${formatAgentReasoningEffortLabel(reasoningEffort)})`;
}
